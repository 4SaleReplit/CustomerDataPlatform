...
export default function CohortBuilder() {
  ...
  const [conditions, setConditions] = useState<Condition[]>([
    { id: '1', type: 'attribute', attribute: '', operator: '', value: '' }
  ]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Create New Cohort</h1>
        </div>
      </div>
                ...
                <div key={condition.id} className="space-y-4">
                  ...
                  <div className="p-4 border rounded-lg bg-gray-50">
                    ...
                    {condition.type === 'attribute' ? (
                      ...
                      // ... keep existing code (segment tag selection)
